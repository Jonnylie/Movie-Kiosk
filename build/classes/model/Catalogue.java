...
public class Catalogue {
    ...
    public Catalogue(Kiosk kiosk) {
        this.kiosk = kiosk;
        this.moviesAvailable = FXCollections.observableArrayList();
        ...
        this.moviesAvailable.add(new Movie("Matrix", 1999, g, 3));
        this.moviesAvailable.add(new Movie("Jurassic Park", 1993, g, 4));
        this.moviesAvailable.add(new Movie("Terminator 2", 1991, g, 3));
        
        g = new Genre("Drama");
        addGenre(g);
        
        this.moviesAvailable.add(new Movie("Titanic", 1997, g, 4));
        
        g = new Genre("Crime");
        addGenre(g);
        this.moviesAvailable.add(new Movie("The Silence of the Lambs", 1991, g, 3));
...
//
    ...
    public  ObservableList<Movie> getMoviesAvailable() {
...
//
    ...
    public ObservableList<Genre> getGenres() {
     ...
     public ObservableList<Movie> getMoviesRented() {
